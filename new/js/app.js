...
function viewShell() {
    ...
    const shellWidth = desktop ? '1080px' : '430px';
...
${state.format === '110' || state.format === 'Sheet' ? `<div style="font-size:12px;color:${C.faint};line-height:1.5">${state.format === '110' ? '110 cartridges are always 24 exposures.' : 'Sheet film is priced one frame per sheet.'}</div>` : ''}
    ...
    return `<div style="position:absolute;inset:0;z-index:40;display:flex;flex-direction:column;justify-content:flex-end">
...
function viewLibFilterModal() {
    ...
    return `<div style="position:absolute;inset:0;z-index:46;display:flex;flex-direction:column;justify-content:flex-end">
...
function viewLibDetail() {
    ...
    const mapsHref = it.kind === 'lab' && it.meta
        ...
        : '';
    return `<div style="position:absolute;inset:0;z-index:47;display:flex;flex-direction:column;justify-content:flex-end">
...
function viewPostModal() {
    ...
    return `<div style="position:absolute;inset:0;z-index:45;display:flex;flex-direction:column;justify-content:flex-end">
...
function viewMenu() {
    ...
    return `<div style="position:absolute;inset:0;z-index:50;display:flex;flex-direction:column;justify-content:flex-start">
...
function viewSetup() {
    ...
    return `<div style="position:absolute;inset:0;z-index:60;display:flex;align-items:flex-start;justify-content:center;padding:28px 16px;overflow:auto">
...
function viewConsent() {
    return `<div style="position:absolute;left:12px;right:12px;bottom:12px;z-index:55;background:${C.panel};border:1px solid ${C.border2};border-radius:12px;padding:14px 16px;box-shadow:0 18px 40px rgba(0,0,0,.5)">
...
function viewChangelog() {
    ...
    return `<div style="position:absolute;inset:0;z-index:62;display:flex;flex-direction:column;justify-content:flex-end">
...
function viewConfirm() {
    ...
    return `<div style="position:absolute;inset:0;z-index:64;display:flex;flex-direction:column;justify-content:flex-end">
...
function viewEditor() {
    ...
    return `<div style="position:absolute;inset:0;z-index:58;background:${C.shell};display:flex;flex-direction:column">
...
function viewSubEditor() {
    ...
    return `<div style="position:absolute;inset:0;z-index:59;background:${C.shell};display:flex;flex-direction:column">
