...
| `TUNNEL_SERVICE_N` | yes, per hostname | Where traffic for that hostname is sent, e.g. `http://app:3000` (the "path" in the original ask — this is the tunnel origin, not a URL path filter) |
